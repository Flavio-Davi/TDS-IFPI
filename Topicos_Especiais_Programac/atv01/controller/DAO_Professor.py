...
from models import modelo_professor as mp
...
class DAO_Professor:    
    ...
    def create_teacher(self, professor: mp.Professor):
        query = """INSERT INTO 
...
VALUES
    (%s, %s, %s, %s, %s);"""
        ...
        self.__cnx.execute_query_update(query, data)
    ...
    def read_all_teacher(self):
        ...
        return self.__cnx.execute_query_read(query)
    ...
    def read_teacher(self, matricula_professor):
        ...
        return self.__cnx.execute_query_read(query, (data,))
...
if __name__ == '__main__':
    d = DAO_Professor()
    p = mp.Professor("Daniele", "Carmen", "2025MP018", date(2004, 6, 21), "danicar@gmail.com")
