...
ALTER TABLE Departamentos ADD FOREIGN KEY (GERENTE) REFERENCES Empregados(MATR);
ALTER TABLE Empregados ADD FOREIGN KEY (DEPT) REFERENCES Departamentos(DCODIGO);
ALTER TABLE Projetos ADD FOREIGN KEY (DCODIGO) REFERENCES Departamentos(DCODIGO);
ALTER TABLE Projetos ADD FOREIGN KEY (RESP) REFERENCES Empregados(MATR);
