...
if __name__ == '__main__':
    ...
    while True:
        ...
        if user == "1":
            ...
            limpar()
            print(" DATA DE CHECK-IN ".center(50, "#"))
            dia = int(input("dia: "))
            mes = int(input("mês: "))
            ano = int(input("ano: "))
            data_checkIN = datetime.date(ano, mes, dia)
            if data_checkIN < hoje:
                raise Exception("Data de check-in inválida.")

            limpar()
            print(" DATA DE CHECK-OUT ".center(50, "#"))
            dia = int(input("dia: "))
            mes = int(input("mês: "))
            ano = int(input("ano: "))
            data_checkOUT = datetime.date(ano, mes, dia)
            if data_checkOUT <= data_checkIN:
                raise Exception("Data de check-out inválida.")
            ...
            try:
                ...
                print(" NOVA DATA DE CHECK-IN ".center(50, "#"))
                dia = int(input("dia: "))
                mes = int(input("mês: "))
                ano = int(input("ano: "))
                novo_checkIN = datetime.date(ano, mes, dia)
                print(" NOVA DATA DE CHECK-OUT ".center(50, "#"))
                dia = int(input("dia: "))
                mes = int(input("mês: "))
                ano = int(input("ano: "))
                novo_checkOUT = datetime.date(ano, mes, dia)
